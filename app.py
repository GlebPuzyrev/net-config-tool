...
with st.sidebar:
    ...
    if selected_platform_folder == "ios":
        driver_platform = "cisco_iosxe"
    elif selected_platform_folder == "nxos":
        driver_platform = "cisco_nxos"
    elif selected_platform_folder == "arubaos-cx":
        driver_platform = "aruba_aoscx"
    elif selected_platform_folder == "arubaos":
        driver_platform = "aruba_aoss"
    elif selected_platform_folder == "fortios":
        driver_platform = "fortinet_fortios"
    else:
        driver_platform = selected_platform_folder
